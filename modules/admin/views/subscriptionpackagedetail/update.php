...
$this->title = 'Update Subscription Package Detail: ' . $model->subscription_package_detail_id;
$modeltitle = 'Subscription Package Detail';
$this->params['breadcrumbs'][] = ['label' => 'Subscription Package Details', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->subscription_package_detail_id, 'url' => ['view', 'id' => $model->subscription_package_detail_id]];
