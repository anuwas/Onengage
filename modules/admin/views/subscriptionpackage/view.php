...
$this->title = $model->subscription_package_id;
...
<section role="main" class="content-body">
					...
					<header class="panel-heading">
								...
								<?= Html::a('Update', ['update', 'id' => $model->subscription_package_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->subscription_package_id], [
