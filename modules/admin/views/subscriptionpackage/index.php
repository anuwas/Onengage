...
/* @var $searchModel app\models\SubscriptionPackageSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Subscription Packages';
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<?= Html::a('Add Subscription Package <i class=\"fa fa-plus\"></i>', ['create'], ['class' => 'btn btn-success']) ?>
										</div>
                                        </div>
